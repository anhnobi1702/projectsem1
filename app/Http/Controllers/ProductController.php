...
class ProductController extends Controller
{
    ...
    public function search(Request $request)
    {
        if($keyword = null){
            ...
            $search_product = DB::table('products')->where('name', 'like', '%'.$keyword.'%')->orWhere('id', 'like', '%'.$keyword.'%')->get();
            return view('admin.product.search')->with('search_product',$search_product);
        }
    }
    ...
    public function create()
    {
        ...
        $size = Size::get();
        $brand = Brand::get();
        return view('admin.product.add', compact('category','material', 'size','brand'));
    }
    ...
    {
        $old_material = MaterialProduct::where('product_id', $id)->pluck('material_id')->toArray();
        ...
        $category = Category::get();
        $brand = Brand::get();
        return view('admin.product.edit',compact('old_product', 'category', 'desImg','material','old_material', 'size', 'old_size','brand'));
    }
    ...
    public function update(ProductRequest $req, $id)
    {
        ...
        if ($req->has('material')) {
            foreach ($req->material as $key => $value) {
