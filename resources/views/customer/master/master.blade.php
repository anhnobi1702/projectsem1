...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,300,400,500,600,700,800,900"
        rel="stylesheet">
    <link rel="shortcut icon" href="{{ url('uploads') }}/LogoShop.png" type="image/x-icon">
            ...
            <div class="container">
                <div class="vishlist">
                    <div class="vishlist-inner">
                        @if (Auth::check())
                            <a href="{{ route('wishlist') }}"><i class="far fa-kiss-wink-heart"></i></a>
                        @else
                            <a href="{{ route('login', 'page=wishlist') }}"><i class="far fa-kiss-wink-heart"></i></a>
                        @endif
                ...
                <nav class="navbar">
                    <div class="nav-header">
                        ...
                        <div class="logo"><a href="{{ route('index') }}"><img
                                    src="{{ url('customer') }}/images/LogoMini.png" alt="logo" /></a></div>
                    </div>
