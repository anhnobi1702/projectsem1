...
@section('banner')
    ...
    <section class="sub-banner">
        ...
        <img src="{{ url('customer') }}/imgbanner/bé3.png" alt="banner" class="banner2" />
    </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 img-part">
                        <figure><img src="{{ url('customer') }}/imgbanner/bé3.png" alt="organic" style="max-width: 100%" class="img-responsive"></figure>
                    </div>
