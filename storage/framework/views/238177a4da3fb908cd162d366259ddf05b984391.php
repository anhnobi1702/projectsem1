    ...
    <div class="row" style="display: inline-block;">
        <div class="tile_count col-md-12">
            <div class="col-md-2 col-sm-4  tile_stats_count">
                ...
                <span class="count_bottom"><i class="green"></i> From <?php echo e(session()->has('time1')?session()->get('time1'):"This Month"); ?></span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
                <span class="count_top"><i class="fa fa-clock-o"></i> Total In <?php echo e(session()->has('time1')?session()->get('time1'):"This Month"); ?></span>
                <div class="count green">$ <?php echo e($total); ?></div>
                <span class="count_bottom"><i class="green"><i></i></i>From <?php echo e(session()->has('time1')?session()->get('time1'):"This Month"); ?></span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
            ...
            <div class="col-md-2 col-sm-4  tile_stats_count">
                ...
                <span class="count_bottom"><i class="green"><i class=""></i></i>From <?php echo e(session()->has('time1')?session()->get('time1'):"This Month"); ?></span>
            </div>
            <div class="col-md-2 col-sm-4  tile_stats_count">
                        ...
                        <div id="" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px;">
                            <form action="<?php echo e(route('getData')); ?>" method="POST">
                                ...
                                <span style="display: flex">
                                    ...
                                    <input type="date" class="form-control" value="<?php echo e(session()->has('time2') ? session()->get('time2') : '2021-08-03'); ?>" name="time2" id="">
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vanda\OneDrive\Máy tính\lastProject\lastProject\resources\views/admin/index/index.blade.php ENDPATH**/ ?>