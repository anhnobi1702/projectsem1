                        ...
                        <div id="" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px;">
                            <form action="<?php echo e(route('getData')); ?>" method="POST">
                                ...
                                <span style="display: flex">
                                    ...
                                    <input type="date" class="form-control" value="<?php echo e(session()->has('time2') ? session()->get('time2') : '2021-08-07'); ?>" name="time2" id="">
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vanda\Desktop\lastProject\resources\views/admin/index/index.blade.php ENDPATH**/ ?>