...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="radio" name="status" class="mr-2" value="1"
                        <?php echo e($old_product->status == 1 ? 'checked' : ''); ?>>Còn
                    <br>
                    <input type="radio" name="status" class="mr-2" value="0"
                        <?php echo e($old_product->status == 0 ? 'checked' : ''); ?>>Hết
                </div>
                <div class="form-group">
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vanda\OneDrive\Máy tính\lastProject\lastProject\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>