...
<?php $__env->startSection('banner'); ?>
    <section class="sub-banner">
        ...
        <img class="banner2" src="<?php echo e(url('customer')); ?>/img banner/bé3.png" alt="banner" />
    </section>
    <!-- /Banner -->
    <!-- Bredcrumb -->
                        ...
                        <div class="product-single-meta">
                            ...
                            <div class="cart-process" style="padding: 0px !important">
                                <div class="qty">
                                    ...
                                    <Select name="material" id="material_id" style="width: 135px;height: 40px;"
                                        class="form-control">
                                        <?php $__currentLoopData = $material; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->material_id); ?>"><?php echo e($item->getName->name); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </Select>
                                </div>
                            </div>
...
<?php echo $__env->make('customer.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PROJECT_SEM1\PROJECT_SEM1\lastProject\resources\views/customer/page/productdetail.blade.php ENDPATH**/ ?>