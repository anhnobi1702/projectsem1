            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-12 col-xs-12 img-part">
                        <figure><img src="<?php echo e(url('customer')); ?>/imgabout/img1.jfif" alt="organic" style="max-width: 100%" class="img-responsive"></figure>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12">
                    ...
                    <div class="owl-carousel owl-theme our-farmer">
                        <?php $__currentLoopData = $farmer; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item">
                            <div class="wrapper">
                                <div class="pro-img">
                                    <img src="<?php echo e(url('uploads')); ?>/<?php echo e($item->avatar); ?>" alt="Farmer" class="img-responsive center-block" />
                                </div>
                                <div class="contain-wrapper">
                                    <div class="tit"><?php echo e($item->name); ?></div>
                                    <div class="post"><?php echo e($item->role); ?></div>
                                    <ul class="social">
...
<?php echo $__env->make('customer.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vanda\OneDrive\Máy tính\lastProject\lastProject\resources\views/customer/page/about.blade.php ENDPATH**/ ?>