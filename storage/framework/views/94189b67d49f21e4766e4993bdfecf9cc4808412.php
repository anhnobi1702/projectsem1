...
<head>
    ...
    <title>Furniture - High-class, luxurious furniture Template for HTML5 and Bootstrap 3</title>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat:100,200,300,400,500,600,700,800,900"
        rel="stylesheet">
    <link rel="shortcut icon" href="<?php echo e(url('uploads')); ?>/LogoShop.png" type="image/x-icon">
    <script src="https://kit.fontawesome.com/f87f4dddd7.js" crossorigin="anonymous"></script>
</head>
            ...
            <div class="container">
                <div class="vishlist">
                    <div class="vishlist-inner">
                        <?php if(Auth::check()): ?>
                            <a href="<?php echo e(route('wishlist')); ?>"><i class="far fa-kiss-wink-heart"></i></a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login', 'page=wishlist')); ?>"><i class="far fa-kiss-wink-heart"></i></a>
                        <?php endif; ?>
                ...
                <nav class="navbar">
                    <div class="nav-header">
                        ...
                        <div class="logo"><a href="<?php echo e(route('index')); ?>"><img
                                    src="<?php echo e(url('customer')); ?>/images/LogoMini.png" alt="logo" /></a></div>
                    </div>
                ...
                <div class="search-and-cart">
                    <div class="search">
                        <div class="search-inner"><a href="#"><i class="fas fa-search"></i></a></div>
                    </div>
                    <div class="cart">
                        <div class="cart-inner">
                            <a style="cursor: pointer"><i class="fas fa-cart-plus"></i></a>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        ...
                        <div class="logo-btm">
                            ...
                            <div class="phone"><i class="icon-icon"></i><a
                                    href="tel:+8888888888">+0971812134</a>
                            </div>
                            <div class="mail"><i class="icon-envelope"></i><a
                                    href="mailto:inquiry@organicfoodstroe.com">son@gmail.com</a></div>
                        </div>
                    </div>
...
<?php /**PATH D:\XAMPP\htdocs\lastProject\resources\views/customer/master/master.blade.php ENDPATH**/ ?>