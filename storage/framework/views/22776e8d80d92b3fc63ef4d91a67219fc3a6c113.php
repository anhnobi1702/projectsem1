                ...
                <?php $__currentLoopData = $shipping; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <th scope="col" class="<?php echo e($item->status == 0 ? 'text-success ' : 'text-danger'); ?>">
                            <?php echo e($item->status == 0 ? 'Active ' : 'Inactive'); ?></th>
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\vanda\OneDrive\Máy tính\lastProject\lastProject\resources\views/admin/shipping/index.blade.php ENDPATH**/ ?>