...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <?php $__currentLoopData = $material; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="checkbox" <?php echo e((in_array($value->id,$old_material))?"checked":""); ?>  class="m-2" name="material[]" value="<?php echo e($value->id); ?>" id=""><?php echo e($value->name); ?>
...
<?php echo $__env->make('admin.master.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\PROJECT_SEM1\PROJECT_SEM1\lastProject\resources\views/admin/product/edit.blade.php ENDPATH**/ ?>