...
<body class="nav-md">
                ...
                <div class="left_col scroll-view">
                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> Material Manager<span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="<?php echo e(route('material.index')); ?>">Show Material</a></li>
                                        <li><a href="<?php echo e(route('material.create')); ?>">Add Material</a></li>
                                    </ul>
                                </li>
                            </ul>
                            <ul class="nav side-menu">
    ...
    <style>
        ...
        .form-search .form-group .input-ajax {
            width: 70%;
...
<?php /**PATH D:\xampp\htdocs\PROJECT_SEM1\PROJECT_SEM1\lastProject\resources\views/admin/master/master.blade.php ENDPATH**/ ?>